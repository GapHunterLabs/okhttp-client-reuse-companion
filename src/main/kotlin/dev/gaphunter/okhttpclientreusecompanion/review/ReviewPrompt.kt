package dev.gaphunter.okhttpclientreusecompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.okhttpclientreusecompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.okhttpclientreusecompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "OkHttp Client Reuse Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/33808-okhttp-client-reuse-companion/reviews"
